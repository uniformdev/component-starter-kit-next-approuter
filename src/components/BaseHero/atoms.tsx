...
import { BaseHeroProps } from './';

export const Title: FC<
  Pick<BaseHeroProps, 'titleStyle' | 'useCustomTextElements' | 'title' | 'component' | 'context'> & {
    className?: string;
  }
> = ({ titleStyle: TitleTag, useCustomTextElements, title, className, component, context }) =>
...
export const EyebrowText: FC<Pick<BaseHeroProps, 'component' | 'context'> & { className?: string }> = ({
  className,
  component,
  context,
}) => (
...
export const Description: FC<Pick<BaseHeroProps, 'component' | 'context'> & { className?: string }> = ({
  className,
  component,
  context,
}) => (
...
export const BackgroundImage: FC<
  Pick<BaseHeroProps, 'image' | 'video' | 'objectFit' | 'overlayOpacity' | 'overlayColor'>
