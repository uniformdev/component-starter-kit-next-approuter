...
export const Title: FC<
  Pick<HeroProps, 'titleStyle' | 'useCustomTextElements' | 'title' | 'component' | 'context'> & { className?: string }
...
export const EyebrowText: FC<Pick<HeroProps, 'component' | 'context'> & { className?: string }> = ({
  className,
  component,
  context,
}) => (
...
export const Description: FC<Pick<HeroProps, 'component' | 'context'> & { className?: string }> = ({
  className,
  component,
  context,
}) => (
