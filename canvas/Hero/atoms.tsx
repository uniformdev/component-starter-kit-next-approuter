...
export const Title: FC<Pick<HeroProps, 'titleStyle' | 'useCustomTextElements' | 'title' | 'context' | 'component'> & { className?: string }> = ({
  titleStyle: TitleTag,
...
export const EyebrowText: FC<Pick<ComponentProps, 'context' | 'component'> & { className?: string }> = ({ className, context, component }) => (
  <UniformText
...
export const Description: FC<Pick<ComponentProps, 'context' | 'component'> & { className?: string }> = ({ className, context, component }) => (
  <UniformText
...
export const PrimaryButton: FC<Pick<HeroProps, 'primaryButtonLink' | 'primaryButtonStyle' | 'animationType' | 'context' | 'component'>> = ({
  primaryButtonLink,
  primaryButtonStyle,
  animationType,
  context,
...
export const SecondaryButton: FC<Pick<HeroProps, 'secondaryButtonLink' | 'secondaryButtonStyle' | 'animationType' | 'context' | 'component'>> = ({
  secondaryButtonLink,
