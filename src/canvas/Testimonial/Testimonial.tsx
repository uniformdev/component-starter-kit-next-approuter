...
export const Testimonial: FC<TestimonialProps> = ({ picture, logo, lineCountRestriction, component, context }) => {
    ...
    <div className={classNames('flex flex-col', { 'card shadow-xl p-4': isCardWrapperVariant })}>
      ...
      <div className="shrink-0 flex mt-8">
        ...
        <div className="flex flex-col ml-4 ">
          ...
          <UniformText
            as="p"
            parameterId="personPosition"
            placeholder="Person Position  goes here"
            component={component}
            context={context}
          />
        </div>
